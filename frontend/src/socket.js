...
//   socket = io(process.env.REACT_APP_API_BASE || "http://localhost:5000");
//   socket.on("connect", () => {
//     // register with logged-in user's matriid or email from localStorage
//     try {
//       const userRaw = localStorage.getItem("userData");
//       const user = userRaw ? JSON.parse(userRaw) : null;
//       if (user) {
//         const key =
//           user.MatriID || user.matid || user.ConfirmEmail || user.email;
//         if (key)
