...
export default function Step2({ nextStep, prevStep, formData }) {
  ...
  if (verified) {
    return (
      ...
      <div className="w-full flex justify-center pt-4 pb-10 bg-gradient-to-b from-rose-50 to-rose-100">
        <div className="bg-white shadow-lg rounded-2xl w-full max-w-md p-2 border border-rose-100 text-center">
