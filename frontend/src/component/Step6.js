...
export default function Step6({ nextStep, prevStep, formData = {} }) {
  ...
  return (
  <div className="max-w-4xl mx-auto bg-white shadow-xl rounded-2xl p-8 border border-gray-100 mt-12">
    {/* Title */}
    <h3 className="text-2xl font-bold text-gray-800 text-center mb-6 border-b pb-3">
      Education & Occupation Details
    </h3>
