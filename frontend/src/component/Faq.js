...
//     a: "In registration via you can upload it. Login to your account and click 'Manage Horoscope' to enter your details.",
//   },
//   {
//     id: 5,
...
//         maxHeight: maxH,
//         transition:
//           "max-height 300ms ease, opacity 200ms ease, transform 300ms ease",
//         overflow: "hidden",
//       }}
//       className={`text-sm text-[#4A1C1C]`}
//     >
//       <div
//         className={`py-2 ${
...
//   return (
//     <main className="min-h-screen bg-[#FFF4E0] text-[#4A1C1C] font-display py-12 overflow-hidden">
...
//           </div>
//           <h1 className="text-3xl font-bold text-[#4A1C1C]">
//             Frequently Asked Questions
//           </h1>
//           <p className="text-sm text-[#6A1B1B]/70 mt-1">
...
//                   open
//                     ? "bg-[#FFF8F4] border-[#C2185B] shadow-md"
//                     : "bg-[#FFF8F4]/70 border-[#E0BFBF] hover:bg-[#FFF8F4]"
//                 }`}
//               >
//                 <h3>
//                   <button
...
//                     aria-expanded={open}
//                     className="w-full flex justify-between items-center text-left text-[#4A1C1C]"
//                   >
//                     <span className="flex items-center gap-3">
//                       <HelpCircle
//                         className={`w-5 h-5 ${
//                           open ? "text-[#C2185B]" : "text-[#6A1B1B]/70"
//                         }`}
//                       />
...
//                         open ? "rotate-180 text-[#C2185B]" : "text-[#6A1B1B]/60"
//                       }`}
//                       fill="currentColor"
//                       viewBox="0 0 20 20"
//                     >
...
//                   id={item.id}
//                   open={open}
//                   className="!text-[#4A1C1C] leading-relaxed"
//                 >
//                   {item.a}
//                 </SmoothAccordionPanel>
//               </article>
