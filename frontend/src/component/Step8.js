  ...
  return (
    <div className="max-w-4xl mx-auto bg-gradient-to-b from-[#fff8f0] to-[#fff0e6] shadow-xl rounded-2xl p-8 border border-[#f3cba5] mt-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {/* Parents Stay */}
        <div className="col-span-2 mt-4 bg-[#fefaf4] p-4 rounded-xl border border-[#f3cba5]">
          <p className="font-semibold text-[#7b1113] mb-3">
            Will parents stay with you after marriage?
          </p>
