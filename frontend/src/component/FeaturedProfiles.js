          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden transform hover:-translate-y-2 transition-transform duration-300">
              ...
              <div className="p-6 text-center">
                ...
                <button className="mt-4 px-5 py-2 bg-gradient-to-r from-pink-600 to-rose-500 text-white font-semibold rounded-full hover:from-pink-700 hover:to-rose-600 transition-all duration-300 shadow-md">
                  View Profile
                </button>
              </div>
            </div>
