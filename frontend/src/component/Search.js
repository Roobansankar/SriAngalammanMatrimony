...
export default function RegularSearch() {
  ...
  function submitSearch(e) {
    e.preventDefault();
    navigate("/results", { state: { filters: form, apiBase: API_BASE } });
  }
  ...
  // ===========================
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#fee2e2] via-[#fca5a5] to-[#ef4444] flex items-center justify-center px-4 py-10 font-display">
      <div className="w-full max-w-4xl bg-white dark:bg-slate-900 shadow-2xl rounded-lg p-8 mt-14">
        {/* Header */}
